...
const TextShared = lazy(() => import("../components/shared/TextShared"));
...
<TextShared />
          ...
          <section className="flex flex-col md:flex-row items-center justify-center w-full py-16 px-2 backdrop-blur-lg mt-6">
            <motion.div
            ...
            >
              ...
              <p className="text-lg md:text-xl leading-relaxed">
                ...
                <Highlighter
                  ...
                  strokeWidth={8}
                />
                , trendsetting pieces crafted for the modern{" "}
                <Highlighter
                  animationDuration={1}
                  text="fashionista"
                  lineStyle="strikethrough"
              ...
              <Link to={"/collections/womens"}>
                {" "}
                <button className="bg-white mt-10 text-gray-800 px-8 py-4 rounded-full font-semibold shadow-lg transition-transform duration-300 hover:scale-110 hover:bg-gray-900 hover:text-white">
                  Shop Now
                </button>
              </Link>
            </motion.div>
